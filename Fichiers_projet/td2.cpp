...
Acteur* trouverActeur(const ListeFilms& listeFilms, string NomActeurRecherche)
{	
	...
	{	
		...
		{
			if ((*acteur).nom == NomActeurRecherche)
				return acteur;
		}
	}
...
void afficherListeFilms(const ListeFilms& listeFilms)
{
	...
	for (const Film* film : span <Film*>{ listeFilms.elements, unsigned(listeFilms.nElements) })
	{
